...
export const metadata: Metadata = generateMetadata({
  title: 'Refund Policy',
  description: 'Read LedgerAI Refund Policy. Learn about our subscription refund terms, cancellation policy, and billing practices for monthly SaaS subscriptions.',
  path: '/legal/refund-policy',
  keywords: 'LedgerAI, refund policy, subscription refunds, cancellation policy, billing terms, SaaS refunds, money back guarantee',
})

export default async function RefundPolicyPage() {
  const content = await getMarkdownContent('refund-policy.md')
