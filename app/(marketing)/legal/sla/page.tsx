...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Read LedgerAI Service Level Agreement (SLA). Learn about our uptime commitments, service availability guarantees, and service credit policies for our SaaS platform.',
  path: '/legal/sla',
  keywords: 'LedgerAI, service level agreement, SLA, uptime guarantee, service availability, service credits, SaaS reliability, 99.5% uptime',
})

export default async function SLAPage() {
  const content = await getMarkdownContent('sla.md')
