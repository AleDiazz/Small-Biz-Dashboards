...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Read LedgerAI Terms of Service. Understand the terms and conditions for using our small business dashboard platform, including subscription terms, user responsibilities, and service limitations.',
  path: '/legal/terms-of-service',
  keywords: 'LedgerAI, terms of service, SaaS terms, small business dashboard, subscription agreement, user agreement, legal terms',
})
