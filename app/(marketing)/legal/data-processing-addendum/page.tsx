...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Read LedgerAI Data Processing Addendum (DPA). GDPR-compliant data processing agreement for EU and UK customers using our SaaS platform.',
  path: '/legal/data-processing-addendum',
  keywords: 'LedgerAI, data processing addendum, DPA, GDPR compliance, data processor agreement, EU data protection, UK GDPR, data processing terms',
})

export default async function DataProcessingAddendumPage() {
  const content = await getMarkdownContent('data-processing-addendum.md')
