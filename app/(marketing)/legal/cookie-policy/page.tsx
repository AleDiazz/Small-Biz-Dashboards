...
export const metadata: Metadata = generateMetadata({
  title: 'Cookie Policy',
  description: 'Read LedgerAI Cookie Policy. Learn about how we use cookies and tracking technologies, manage cookie preferences, and protect your privacy.',
  path: '/legal/cookie-policy',
  keywords: 'LedgerAI, cookie policy, cookies, tracking technologies, web analytics, privacy settings, cookie preferences, GDPR cookies',
})

export default async function CookiePolicyPage() {
  const content = await getMarkdownContent('cookie-policy.md')
