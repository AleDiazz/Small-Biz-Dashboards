...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Read LedgerAI Acceptable Use Policy. Understand the rules and guidelines for using our small business dashboard platform, including prohibited activities and user responsibilities.',
  path: '/legal/acceptable-use-policy',
  keywords: 'LedgerAI, acceptable use policy, AUP, terms of use, user guidelines, prohibited activities, platform rules, service usage terms',
})

export default async function AcceptableUsePolicyPage() {
  const content = await getMarkdownContent('acceptable-use-policy.md')
